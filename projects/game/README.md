...
* hasKey - Keeps track of whether the player has the key. It Allows the player to unlock the exit door and escape.

* hasPass - Keeps track of whether the player has the pass. Provides another way for the player to leave the school.

* energy - Tracks the player's energy level. Can increase when talking to Prithvi and may affect gameplay decisions.